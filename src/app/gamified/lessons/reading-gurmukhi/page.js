...
// Gurmukhi Letters for learning how to read
const letters = [
...
export default function ReadingGurmukhi() {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-purple-50 to-purple-100 px-6 pt-32 pb-20">

            {/* Back Button - Return to Reading & Writing Lessons */}
            <div className="w-full max-w-4xl mb-8 flex justify-start">
                <button
                    onClick={() => router.push("/learning/reading-writing")}
