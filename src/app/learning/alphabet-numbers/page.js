...
export default function AlphabetNumbers() {
    ...
    const lessons = [
        { title: "Lesson 1: Introduction to Gurmukhi", link: "/gamified/lessons/alphabet", locked: false },
        { title: "Lesson 2: Counting to 10", link: "/gamified/lessons//counting-to-10", locked: false },
