...
import { FaArrowLeft, FaCheck, FaLock, FaBook, FaRocket, FaPlay, FaStar, FaArrowRight } from "react-icons/fa";
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="rounded-2xl mb-12 relative overflow-hidden" style={{ backgroundColor: 'var(--color-navy)' }}>
                        ...
                        <div className="relative z-10 px-8 sm:px-12 py-10 sm:py-14">
                            <p className="text-xs font-semibold uppercase tracking-[0.15em] text-gray-400 mb-3">Beginner Course</p>
                            <h1 className="text-3xl sm:text-4xl font-display text-white mb-3">
                                Essential Punjabi for<br />
                                <span className="text-saffron">Real Conversations</span>
                            </h1>
                            <p className="text-gray-400 text-base mb-8 max-w-2xl">
                                Master the basics and start speaking Punjabi confidently from day one. Perfect for complete beginners.
                            </p>
                    ...
                    <div className="mb-12">
                        <div className="mb-8">
                            <p className="text-xs font-semibold uppercase tracking-[0.15em] text-saffron mb-2">Lessons</p>
                            <h2 className="text-2xl font-display text-navy">Course Lessons</h2>
                        </div>
