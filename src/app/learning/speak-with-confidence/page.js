...
export default function SpeakWithConfidence() {
    ...
    const lessons = [
        ...
        { id: "lesson6", title: "Making It Easy and Top Tips", description: "Advanced strategies for fluency", link: "/lessons/lesson6", locked: true },
    ];
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="rounded-2xl mb-12 relative overflow-hidden" style={{ backgroundColor: 'var(--color-navy)' }}>
                        ...
                        <div className="relative z-10 px-8 sm:px-12 py-10 sm:py-14">
                            <p className="text-xs font-semibold uppercase tracking-[0.15em] text-saffron mb-3">Intermediate Course</p>
                            <h1 className="text-3xl sm:text-4xl font-display text-white mb-3">
                                Speak with Confidence<br />
                                <span className="text-saffron">Beyond the Basics</span>
                            </h1>
